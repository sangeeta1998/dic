...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.92\columnwidth]{Images/Sys_model13.pdf}
...
\begin{figure*}[t]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \caption{Average task latency vs.\ number of IoT devices.}
    \label{fig:latency}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\linewidth]{Images/energy_comparison.pdf}
    \caption{Energy consumption per task vs.\ number of IoT devices.}
    \label{fig:energy}
  \end{subfigure}
...
\begin{figure*}[t]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \caption{SLA violation rate vs.\ number of IoT devices.}
    \label{fig:sla}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\linewidth]{Images/migrations_time.pdf}
    \caption{Service migrations per time slot ($N=200$).}
    \label{fig:mig_time}
  \end{subfigure}
  \caption{SLA violation rate and service migration count over time.
           Shaded band in (a) denotes one standard deviation.}
  \label{fig:sla_mig}
\end{figure*}
